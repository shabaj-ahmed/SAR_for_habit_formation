...
def initialise_persistent_database(session):
    ...
    if existing_service_states:
        ...
        service_states = [
            ...
            ServiceState(service_name="robot_control", state_name="free_play", state_value="disable"),
            ...
            ServiceState(service_name="user_interface", state_name="brightness", state_value=str(configs.get_brightness())),
