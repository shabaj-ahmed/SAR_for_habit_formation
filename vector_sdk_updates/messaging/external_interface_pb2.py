...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'anki_vector.messaging.external_interface_pb2', _globals)
if not _descriptor._USE_C_DESCRIPTORS:
  DESCRIPTOR._loaded_options = None
  _globals['_PROTOCOLVERSION']._loaded_options = None
  _globals['_PROTOCOLVERSION']._serialized_options = b'\020\001'
  _globals['_EXTERNALINTERFACE'].methods_by_name['ProtocolVersion']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['ProtocolVersion']._serialized_options = b'\202\323\344\223\002\031\"\024/v1/protocol_version:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['SDKInitialization']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['SDKInitialization']._serialized_options = b'\202\323\344\223\002\033\"\026/v1/sdk_initialization:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['ListAnimations']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['ListAnimations']._serialized_options = b'\202\323\344\223\002\030\"\023/v1/list_animations:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['ListAnimationTriggers']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['ListAnimationTriggers']._serialized_options = b'\202\323\344\223\002 \"\033/v1/list_animation_triggers:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DisplayFaceImageRGB']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DisplayFaceImageRGB']._serialized_options = b'\202\323\344\223\002\037\"\032/v1/display_face_image_rgb:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EventStream']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EventStream']._serialized_options = b'\202\323\344\223\002)\"\020/v1/event_stream:\001*Z\022\022\020/v1/event_stream'
  _globals['_EXTERNALINTERFACE'].methods_by_name['AssumeBehaviorControl']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['AssumeBehaviorControl']._serialized_options = b'\202\323\344\223\002 \"\033/v1/assume_behavior_control:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CancelFaceEnrollment']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CancelFaceEnrollment']._serialized_options = b'\202\323\344\223\002\037\"\032/v1/cancel_face_enrollment:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['RequestEnrolledNames']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['RequestEnrolledNames']._serialized_options = b'\202\323\344\223\002\037\"\032/v1/request_enrolled_names:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['UpdateEnrolledFaceByID']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['UpdateEnrolledFaceByID']._serialized_options = b'\202\323\344\223\002#\"\036/v1/update_enrolled_face_by_id:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EraseEnrolledFaceByID']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EraseEnrolledFaceByID']._serialized_options = b'\202\323\344\223\002\"\"\035/v1/erase_enrolled_face_by_id:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EraseAllEnrolledFaces']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EraseAllEnrolledFaces']._serialized_options = b'\202\323\344\223\002!\"\034/v1/erase_all_enrolled_faces:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetFaceToEnroll']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetFaceToEnroll']._serialized_options = b'\202\323\344\223\002\033\"\026/v1/set_face_to_enroll:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMarkerDetection']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMarkerDetection']._serialized_options = b'\202\323\344\223\002 \"\033/v1/enable_marker_detection:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableFaceDetection']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableFaceDetection']._serialized_options = b'\202\323\344\223\002\036\"\031/v1/enable_face_detection:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMotionDetection']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMotionDetection']._serialized_options = b'\202\323\344\223\002 \"\033/v1/enable_motion_detection:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMirrorMode']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableMirrorMode']._serialized_options = b'\202\323\344\223\002\033\"\026/v1/enable_mirror_mode:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableImageStreaming']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['EnableImageStreaming']._serialized_options = b'\202\323\344\223\002\037\"\032/v1/enable_image_streaming:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['IsImageStreamingEnabled']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['IsImageStreamingEnabled']._serialized_options = b'\202\323\344\223\002#\"\036/v1/is_image_streaming_enabled:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CancelActionByIdTag']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CancelActionByIdTag']._serialized_options = b'\202\323\344\223\002 \"\033/v1/cancel_action_by_id_tag:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['GoToPose']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['GoToPose']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/go_to_pose:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DockWithCube']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DockWithCube']._serialized_options = b'\202\323\344\223\002\027\"\022/v1/dock_with_cube:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DriveOffCharger']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DriveOffCharger']._serialized_options = b'\202\323\344\223\002\032\"\025/v1/drive_off_charger:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DriveOnCharger']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DriveOnCharger']._serialized_options = b'\202\323\344\223\002\031\"\024/v1/drive_on_charger:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['FindFaces']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['FindFaces']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/find_faces:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['LookAroundInPlace']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['LookAroundInPlace']._serialized_options = b'\202\323\344\223\002\035\"\030/v1/look_around_in_place:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['RollBlock']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['RollBlock']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/roll_block:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['PhotosInfo']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['PhotosInfo']._serialized_options = b'\202\323\344\223\002\024\"\017/v1/photos_info:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['Photo']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['Photo']._serialized_options = b'\202\323\344\223\002\016\"\t/v1/photo:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['Thumbnail']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['Thumbnail']._serialized_options = b'\202\323\344\223\002\022\"\r/v1/thumbnail:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DeletePhoto']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DeletePhoto']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/delete_photo:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['UserAuthentication']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['UserAuthentication']._serialized_options = b'\202\323\344\223\002\034\"\027/v1/user_authentication:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['BatteryState']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['BatteryState']._serialized_options = b'\202\323\344\223\002\026\"\021/v1/battery_state:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['VersionState']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['VersionState']._serialized_options = b'\202\323\344\223\002\026\"\021/v1/version_state:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['SayText']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['SayText']._serialized_options = b'\202\323\344\223\002\021\"\014/v1/say_text:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['ConnectCube']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['ConnectCube']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/connect_cube:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DisconnectCube']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DisconnectCube']._serialized_options = b'\202\323\344\223\002\030\"\023/v1/disconnect_cube:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CubesAvailable']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CubesAvailable']._serialized_options = b'\202\323\344\223\002\030\"\023/v1/cubes_available:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['FlashCubeLights']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['FlashCubeLights']._serialized_options = b'\202\323\344\223\002\032\"\025/v1/flash_cube_lights:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['ForgetPreferredCube']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['ForgetPreferredCube']._serialized_options = b'\202\323\344\223\002\036\"\031/v1/forget_preferred_cube:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetPreferredCube']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetPreferredCube']._serialized_options = b'\202\323\344\223\002\033\"\026/v1/set_preferred_cube:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DeleteCustomObjects']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DeleteCustomObjects']._serialized_options = b'\202\323\344\223\002\036\"\031/v1/delete_custom_objects:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CreateFixedCustomObject']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CreateFixedCustomObject']._serialized_options = b'\202\323\344\223\002#\"\036/v1/create_fixed_custom_object:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['DefineCustomObject']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['DefineCustomObject']._serialized_options = b'\202\323\344\223\002\035\"\030/v1/define_custom_object:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['AudioFeed']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['AudioFeed']._serialized_options = b'\202\323\344\223\002\023\"\016/v1/audio_feed:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CameraFeed']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CameraFeed']._serialized_options = b'\202\323\344\223\002\024\"\017/v1/camera_feed:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['CaptureSingleImage']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['CaptureSingleImage']._serialized_options = b'\202\323\344\223\002\035\"\030/v1/capture_single_image:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetEyeColor']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['SetEyeColor']._serialized_options = b'\202\323\344\223\002\026\"\021/v1/set_eye_color:\001*'
  _globals['_EXTERNALINTERFACE'].methods_by_name['NavMapFeed']._loaded_options = None
  _globals['_EXTERNALINTERFACE'].methods_by_name['NavMapFeed']._serialized_options = b'\202\323\344\223\002\025\"\020/v1/nav_map_feed:\001*'
  _globals['_PROTOCOLVERSION']._serialized_start=295
  _globals['_PROTOCOLVERSION']._serialized_end=406
  _globals['_EXTERNALINTERFACE']._serialized_start=409
  _globals['_EXTERNALINTERFACE']._serialized_end=11254
